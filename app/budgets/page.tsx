                            ...
                            <div className="flex items-center justify-between mb-2">
                              ...
                              <div className="flex items-center gap-2">
                                <Button
                                  ...
                                  className="brut-border"
                                  aria-label={`Add spending to ${status.budget.category} budget`}
                                  title={`Add spending to ${status.budget.category} budget`}
                                >
                          ...
                          {editingId === budget.id ? (
                            ...
                            <div className="flex gap-2">
                              <Button
                                ...
                                aria-label={`Add spending to ${budget.category} budget`}
                                title={`Add spending to ${budget.category} budget`}
                              >
                                <DollarSign className="w-3 h-3" />
                              </Button>
                              <Button
